...
>
	<div
		class="border border-black/10 bg-white text-neutral-900 rounded-box overflow-hidden"
	>
		@if ($showTopBar)
		...
		<div class="overflow-x-auto">
			<table class="w-full table-fixed border-collapse">
				...
				<tbody class="bg-white divide-y divide-neutral-800/10">
					<template
						x-for="(row, index) in state"
						:key="'row-' + index"
					>
						<tr
						...
						>
							@if ($reorderable)
								<td class="px-3 py-2 text-center border-0 w-12">
									<div
									...
									>
										<x-ui.icon
											name="bars-3"
											class="size-4 text-neutral-400 hover:text-neutral-600"
										/>
									</div>
								</td>
							@endif
		...
		<div class="bg-white px-4 py-3 border-t border-neutral-800/10">
