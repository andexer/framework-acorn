...
@php
	...
	$labelClasses = [
		...
		'text-neutral-300 hover:text-neutral-950 p-2 rounded-field peer-checked:shadow-xs peer-checked:bg-white/80 hover:bg-white ' => $isSegmented,
	...
	$containerClasses = [
		...
		'flex-1 bg-white py-4 px-6 rounded-field border border-black/5 hover:bg-neutral-100' => $isCards,
		'has-[:checked]:bg-white/5 has-[:checked]:border-neutral-950/10 ' => $isCards,
	];

	$descriptionClasses = ['text-neutral-700 w-full text-sm text-start', 'pl-0!' => $isCards, 'pl-5 ' => !$isCards];
