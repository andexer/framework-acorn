...
@php
	...
	$kbdClasses =
		'pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border border-neutral-200 bg-neutral-100 px-1.5 font-sans text-[10px] font-medium text-neutral-700 opacity-100 ';
