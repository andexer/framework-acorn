...
<div
	class="absolute z-50 bg-white [:where(&)]:w-full mt-1 backdrop-blur-xl border border-neutral-200 rounded-(--popup-round) shadow-lg py-(--popup-padding)"
...
>
	...
	<ul
		...
		@if (!$preventLoading) wire:loading.attr="data-loading" @endif
		x-rover:options
	>
		{{ $slot }}
