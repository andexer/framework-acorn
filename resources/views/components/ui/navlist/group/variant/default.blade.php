...
>
	...
	@if ($collapsable)
		<button
			x-on:click="expand()"
			class="p-2 rounded-box cursor-pointer hover: hover:bg-neutral-900/5"
			type="button"
		>
			<x-ui.icon
				x-show="!expanded"
...
<div
	@if ($collapsable)
		...
		x-collapse
	@endif
	class="[:has([data-collapsed]_&)_&]:items-center flex flex-col gap-y-1 ml-2 rtl:mr-2 [:has([data-collapsed]_&)_&]:m-0"
>
	{{ $slot }}
</div>
