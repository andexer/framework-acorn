...
@php
	$classes = [
		...
		'[&_[data-slot=header]]:sticky',
		'[&_[data-slot=header]]:top-0',
		'[&_[data-slot=header]]:z-50',
		'[&_[data-slot=header]]:h-[var(--header-height)]',

		'[&_[data-slot=sidebar]]:fixed',
		'[&_[data-slot=sidebar]]:inset-y-0',
		'[&_[data-slot=sidebar]]:left-0',
		'[&_[data-slot=sidebar]]:top-[var(--header-height)]',
		'[&_[data-slot=sidebar]]:h-[calc(100vh_-_var(--header-height))]',
		'[&_[data-slot=sidebar]]:z-40',
		...
		'md:grid-rows-[var(--header-height)_1fr]',
		...
		'md:[&_[data-slot=sidebar]]:h-auto',
		'md:[&_[data-slot=sidebar]]:top-0',
		'md:[&_[data-slot=sidebar]]:inset-y-auto',
		'md:[&_[data-slot=sidebar]]:overflow-visible',

		'lg:grid-cols-[var(--sidebar-width)_1fr]',
		'lg:grid-rows-[var(--header-height)_1fr]',
