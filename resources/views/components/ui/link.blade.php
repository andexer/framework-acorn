...
@php
	$classes = [
		...
		match ($variant) {
			'soft' => 'text-neutral-500 hover:text-neutral-800 ',
			default => match ($primary) {
				true
					=> 'text-[var(--color-primary-content)] decoration-[color-mix(in_oklab,var(--color-primary-content),transparent_80%)]',
				false => 'text-neutral-800 decoration-neutral-800/20 ',
			},
		},
	];
@endphp
