...
new class extends Component
{
	...
	public function imageReady(string $base64): void
	{
		...
		$this->dispatch(
			'notify',
			type: 'success',
			content: __('Foto de perfil actualizada', 'framework'),
			duration: 3000
		);

		$this->dispatch('file-avatar-updated', base64: $base64);
	}
};
?>
		...
		<div wire:ignore>
			...
			>
				...
				<div class="flex items-center gap-5 w-full animate-pulse">
					<div class="shrink-0 p-[3px] rounded-full bg-zinc-200">
						<div class="size-24 sm:size-28 rounded-full bg-zinc-100 border-4 border-white"></div>
					</div>
