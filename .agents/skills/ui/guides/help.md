...
## Need Help With My Components UI?
...
Join our My Components UI Discord where the core team and contributors hang out. Ask questions, share components, or just vibe with the Laravel UI dev crowd.
...
Open a thread in [My Components UI Discussions](https://github.com/orgs/uiui/discussions) for:
...
[Submit a bug →](https://github.com/uiui/components/issues/new
)

## Still Stuck?


If it’s a question, bug, or feedback we want to hear it. My Components UI isn't just a platform. It’s a community.
