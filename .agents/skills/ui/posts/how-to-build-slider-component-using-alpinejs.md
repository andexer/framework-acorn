...
**Step 1: Install via My Components UI CLI**
```bash
```
...
<x-md.callout title="AI Credits">
    This article is 80-90% written by hand to speak to you directly in a human, understandable way. The remaining 10-20% consists of refinements by AI (Claude) and grammar corrections, since the My Components UI team are not native English speakers.
    <br/>
