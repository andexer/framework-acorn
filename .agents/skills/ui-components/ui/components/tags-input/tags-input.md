...
@blade
<x-demo  x-data="{ tags: ['convergephp','ui','eigenify']}">
    <x-ui.tags-input 
        x-model="tags" 
...
```html
<div class="w-full" x-data="{ tags: ['convergephp','ui','eigenify']}">
    <x-ui.tags-input 
        x-model="tags" 
        placeholder="Add tags..."
    />
...
@blade
<x-demo  >
    <div   x-data="{ tags: ['convergephp','ui','eigenify']}">
        <x-ui.tags-input 
            x-model="tags" 
...
@blade
<x-demo  >
    <div class="space-y-6 max-w-2xlw-full mx-auto h-[25rem] overflow-y-auto p-4" x-data="{ tags: ['convergephp','ui','eigenify']}">
        @foreach([
